var config = {
    ...
    chapters: [
      ...
      },
      {
        ...
        image: "",
        description:
          'მიმდინარე წელს, თბილისს კიდევ <span style="color: #9a0000;"><strong>13.5 კმ</strong></span> სიგრძის ავტობუსების ზოლი შეემატა და ქსელის საერთო სიგრძემ <span style="color: #9a0000;"><strong>60 კმ-ს</strong></span> გადააჭარბა. თბილისის მერიის მიერ რეფორმის გამოცხადების და ',
        location: {
          center: [44.809, 41.733],
          zoom: 11.15,
          pitch: 0.0,
